...
int main()
{
    ...
    test
    {
        ll n, ans = 0, idx_left = 0, idx_right , zero = 0, one = 0, not_sure = 0;
        string v;
        cin >> v;
        n = v.size();
        idx_right=n-1;
        ...
        if (zero == n or one == n or v[0] == '0' or v[n - 1] == '1')
        {
            ans = 1;
        }
        else if (not_sure == n)
        ...
        else
        {
            ...
            for0(i, n)
            {
                if (v[i] == '1')
                {
                    idx_left = max(i, idx_left);
                }
            }
            // debug(idx_left)
            //  debug(idx_right)
            // debug(idx_left - idx_right)
